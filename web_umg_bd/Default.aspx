...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:TextBox ID="txt_direccion" runat="server" CssClass="form-control" placeholder="lote Casa Avenida Zona Ciudad"></asp:TextBox>
    <br />
    <asp:Label ID="lbl_telefono" runat="server" CssClass="badge" Text="Telefono"></asp:Label>
    <asp:TextBox ID="txt_telefono" runat="server" CssClass="form-control" TextMode="Number" placeholder="12345678"></asp:TextBox>
    <br />
